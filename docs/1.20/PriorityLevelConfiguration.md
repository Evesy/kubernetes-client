...
## read
  ...
  ### apis.flowcontrol.apiserver.k8s.io.v1alpha1.prioritylevelconfigurations.get
  ...
  ### apis.flowcontrol.apiserver.k8s.io.v1alpha1.watch.prioritylevelconfigurations.get
  ...
  ### apis.flowcontrol.apiserver.k8s.io.v1beta1.prioritylevelconfigurations.get
  ...
  ### apis.flowcontrol.apiserver.k8s.io.v1beta1.watch.prioritylevelconfigurations.get
...
## write
  ...
  ### apis.flowcontrol.apiserver.k8s.io.v1alpha1.prioritylevelconfigurations.delete
  ...
  ### apis.flowcontrol.apiserver.k8s.io.v1alpha1.prioritylevelconfigurations.post
  ...
  | Parameter | Description |
  | --------- | ----------- |
  | `body` | #&#x2F;definitions&#x2F;io.k8s.api.flowcontrol.v1alpha1.PriorityLevelConfiguration |

  ### apis.flowcontrol.apiserver.k8s.io.v1beta1.prioritylevelconfigurations.delete
  ...
  ### apis.flowcontrol.apiserver.k8s.io.v1beta1.prioritylevelconfigurations.post
  ...
  | Parameter | Description |
  | --------- | ----------- |
  | `body` | #&#x2F;definitions&#x2F;io.k8s.api.flowcontrol.v1beta1.PriorityLevelConfiguration |
